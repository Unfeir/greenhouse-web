...
import type { ReadingPage, Sensor, SensorStats } from "./types";
...
export function fetchStats(sensorId: string): Promise<SensorStats> {
  return getJson<SensorStats>(`/sensors/${sensorId}/stats`);
}
